...
* <mark>`01-agentic-rag/lessons/14-agentic-loop.md`</mark>
...
Use deepseek. How many input (prompt) tokens did we send to the model for this request?
...
We'll read the input tokens from <mark>response.usage.total_tokens</mark>.
